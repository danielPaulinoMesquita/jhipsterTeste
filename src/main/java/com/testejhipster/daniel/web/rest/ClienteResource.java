...
import com.testejhipster.daniel.service.impl.ClienteServiceImpl;
...
/**
 * REST controller for managing {@link com.testejhipster.daniel.domain.Cliente}.
 */
@RestController
@RequestMapping("/api")
public class ClienteResource {
    ...
    @PostMapping("/clientesNew")
    public ResponseEntity<Cliente> createClienteNew(@RequestBody ClienteNewDTO clienteNewDTO) throws URISyntaxException {

        Cliente cliente= ClienteServiceImpl.parseDto(clienteNewDTO);
