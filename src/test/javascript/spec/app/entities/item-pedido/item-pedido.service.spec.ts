...
describe('Service Tests', () => {
  describe('ItemPedido Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new ItemPedido(0, 0, 0, 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a ItemPedido', async () => {
      ...
      it('should update a ItemPedido', async () => {
        const returnedFromService = Object.assign(
          {
            desconto: 1,
            quantidade: 1,
      ...
      it('should return a list of ItemPedido', async () => {
        const returnedFromService = Object.assign(
          {
            desconto: 1,
            quantidade: 1,
      ...
      it('should delete a ItemPedido', async () => {
