...
public class ClienteResourceIT {
    ...
    private static final String DEFAULT_CPF_OU_CNPJ = "AAAAAAAAAA";
    private static final String UPDATED_CPF_OU_CNPJ = "BBBBBBBBBB";

    private static final TipoCliente DEFAULT_TIPO = TipoCliente.PESSOAFISICA;
    private static final TipoCliente UPDATED_TIPO = TipoCliente.PESSOAJURIDICA;
...
//    }
    public static Cliente createEntity(EntityManager em) {
        ClienteNewDTO clienteNewDTO=new ClienteNewDTO(1L,"","","",DEFAULT_TIPO,"",
            "","","","","","","");
    ...
    public static Cliente createUpdatedEntity(EntityManager em) {
        ClienteNewDTO clienteNewDTO=new ClienteNewDTO(1L,"update","update@hotmail.com","",DEFAULT_TIPO,"",
            "","","","","","","");
        Cliente cliente = new Cliente(clienteNewDTO);
    ...
    public void createCliente() throws Exception {
        ...
        assertThat(testCliente.getCpfOuCnpj()).isEqualTo(DEFAULT_CPF_OU_CNPJ);
    ...
    public void getAllClientes() throws Exception {
        ...
        restClienteMockMvc.perform(get("/api/clientes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].cpfOuCnpj").value(hasItem(DEFAULT_CPF_OU_CNPJ.toString())))
    ...
    public void getCliente() throws Exception {
        ...
        restClienteMockMvc.perform(get("/api/clientes/{id}", cliente.getId()))
            ...
            .andExpect(jsonPath("$.cpfOuCnpj").value(DEFAULT_CPF_OU_CNPJ.toString()))
    ...
    public void updateCliente() throws Exception {
        ...
        assertThat(testCliente.getCpfOuCnpj()).isEqualTo(UPDATED_CPF_OU_CNPJ);
    ...
    public void equalsVerifier() throws Exception {
        ...
        ClienteNewDTO clienteNewDTO= new ClienteNewDTO(1L,"teste","teste@hot.com","123",DEFAULT_TIPO,"",
            "","1","","","","Rec","DF");

        Cliente cliente1 = new Cliente(clienteNewDTO);
        cliente1.setId(1L);
        Cliente cliente2 = new Cliente(clienteNewDTO);
